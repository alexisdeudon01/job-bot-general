...
if qt_is_installed:
    ...
    def toqimage(im: Image.Image | str | QByteArray) -> "ImageQt":
        """
        Convert a PIL image to a Qt QImage wrapper.

        This function requires PyQt6 or PySide6 to be installed.
        """
        raise ImportError("Qt bindings (PyQt6/PySide6) are not available")
