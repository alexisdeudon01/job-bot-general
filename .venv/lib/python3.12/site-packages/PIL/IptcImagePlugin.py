...
# $Id$
#
# NOTE: This file is part of a generated virtual environment (Pillow in .venv).
# It should not be committed to source control; instead, declare Pillow as a
# dependency (e.g., in requirements.txt or pyproject.toml) and let tooling
